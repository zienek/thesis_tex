...
\section{Pilar MK II}
Akustyczny system wykrywania strza³ów i lokalizacji strzelca PILAR Mk IIw firmy 01db-Metravib jest przedstawicielem rodziny akustycznych systemów detekcji strza³ów (AGDS - Acoustic Gunshot Detection System). \cite{PilarMK2}
...
PILAR jest systemem wykrywaj¹cym strzelca w promieniu 360 stopni w azymucie oraz 60 stopni w elewacji. Jest w stanie wykryæ i zlokalizowaæ strza³ z broni o kalibrze id 5,56 mm do 25 mm, zarówno pojedyñczy jak i seriê i strza³y zsynchronizowane. Tak¿e inne typy broni, wyposa¿one w t³umik i bez, granaty moŸdzierzowe. Jego dok³adnoœæ zosta³a okreœlona na $\pm$2$^\circ$ w azymucie z u¿yciem jednej lub dwóch matryc mikrofonów; $\pm$5$^\circ$ w elewacji; $\pm$10\% do $\pm$20\%; zasiêg wykrywania 1500m. Czas od zarejestrowania do wyœwietlenia wyników nie przekracza dwóch sekund. 
